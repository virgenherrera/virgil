...
1. [Que es Virgil](que-es-virgil.md) -- Identidad, limites y forma de comunicacion de Virgil.
2. [Modos y roles](modos-y-roles.md) -- Los 7 actores canonicos, los 2 modos operativos y como se delega autoridad.
3. [Modelo de tres capas](modelo-tres-capas.md) -- Principia, Dogma y Runtime: que vive en cada capa y que puede cambiar.
